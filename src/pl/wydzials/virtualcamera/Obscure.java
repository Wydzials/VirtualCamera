...
public class Obscure {
    ...
    public static void main(String[] args) {
        ...
        Point poindD = new Point(1,-5,1);
        Point poindE = new Point(2,-5,1);
//        Point poindE = new Point(-6.29,1.07,-3.2);

        int sideDecision = areTwoPointsSameSide(poindD, poindE, planeIndexes);
        if (sideDecision == -1)
